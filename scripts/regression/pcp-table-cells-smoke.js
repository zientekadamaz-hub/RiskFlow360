...
assert.match(cellsSource, /export const pcpTableHeaderStyle/, 'PCP table cells must export shared PCP header style.')
assert.match(cellsSource, /export const pcpHiddenTableHeaderStyle/, 'PCP table cells must export hidden PCP header style.')
...
assert.match(cellsSource, /settingsTableCellStyle/, 'PCP cells must use the shared standard table cell style.')
assert.match(cellsSource, /settingsTableHeaderStyle/, 'PCP header cells must use the shared standard table header style.')
assert.match(cellsSource, /settingsHiddenTableColumnWidthPx/, 'PCP hidden cells must use the shared hidden column width.')
...
assert.match(pageSource, /PcpTopSummary/, 'PCP page must use the standard PCP summary component.')
assert.doesNotMatch(pageSource, /from '@\/features\/pcp\/pcp-table-cells'/, 'PCP page should not import table cell internals directly.')
...
assert.doesNotMatch(pageSource, /<SummaryCard/, 'PCP page should not render local summary cards after standardization.')
