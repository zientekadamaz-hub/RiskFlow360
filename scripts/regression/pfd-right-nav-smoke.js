...
assert.match(canvasSource, /import \{ PfdRightNav \}/, 'PFD flow canvas must import right navigation component.')
assert.match(canvasSource, /<PfdRightNav projectId=\{projectId\} \/>/, 'PFD flow canvas must delegate right navigation rendering.')
