...
4. Kontynuowac PFMEA cleanup: remaining risk matrix helpers/constants, action button style, a potem rozbicie stanu tabeli i save/publish orchestration.
