...
4. Kontynuowac PFMEA cleanup: rozbicie pozostalego stanu tabeli, pending cell update queue i save/publish orchestration. Plik strony jest juz glownie kontenerem stanu, efektow, loaderow i glownego renderu tabeli.
