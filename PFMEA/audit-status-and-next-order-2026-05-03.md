...
4. Kontynuowac fizyczne odchudzanie PFMEA UI: nastepny etap to wydzielenie action status select (`TdSelect`), a potem remaining table/save orchestration cleanup.
