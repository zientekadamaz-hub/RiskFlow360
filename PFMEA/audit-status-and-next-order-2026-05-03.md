...
| Obszar | Status | Uwagi |
|---|---|---|
| Build/lint/typecheck/check | DONE | `npm run check`, lint, typecheck, build i regression shared przeszly po ostatniej rundzie. Po poprawce PCP service/PFMEA top summary ponownie: lint PASS, typecheck PASS, build PASS, regression shared PASS. |
...
| 7 | B-005 | PFMEA service layer | PARTIAL | Wazne, ale najwyzsze ryzyko; robic etapami po testach i po pomiarze save timings. |
...
4. Dopiero potem kontynuowac PFMEA service layer, zaczynajac od save/publish orchestration.
