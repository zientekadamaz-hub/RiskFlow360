...
4. Kontynuowac fizyczne odchudzanie PFMEA UI: nastepny etap to ostrozne wydzielanie kolejnych editorow komorek. Najmniejszy bezpieczny kandydat: `TdPcpToggle`, a potem date/action status controls.
