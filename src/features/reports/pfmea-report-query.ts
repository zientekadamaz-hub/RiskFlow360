export const PFMEA_REPORT_RISK_FIELDS =
  'id,operation_id,row_no,created_at,failure_mode_group_id,failure_block_group_id,action_plan_group_id,action_status,severity,occurrence,detection,occurrence2,detection2,oxd_current,rpn_current,rpn'
